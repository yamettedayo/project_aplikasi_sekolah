...
session_start();
  ...
  if (!isset($_SESSION['username']) && $_SESSION['peran']=="siswa" ){ 
      header("Location: ../index.php"); 
  }
    
$konten = $_GET['page'];
if(empty($konten)) $konten="dashboard";
?>
        ...
        <div class="container-xl">
          ...
          <div class="navbar-nav flex-row order-md-last">
            <div class="d-none d-md-flex">
              <a href="?page=<?php echo $konten;?>&theme=dark" class="nav-link px-0 hide-theme-dark" title="Enable dark mode" data-bs-toggle="tooltip" data-bs-placement="bottom">
            ...
            <div class="nav-item dropdown">
              <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                <span class="avatar avatar-sm" style="background-image: url(fotosiswa/<?php echo $_SESSION["foto"];?>)"></span>
                <div class="d-none d-xl-block ps-2">
                  <div><?php echo $_SESSION['nis'];?></div>
